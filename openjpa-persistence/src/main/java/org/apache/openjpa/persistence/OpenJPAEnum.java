...
public interface OpenJPAEnum<E extends Enum<?>> {
     ...
     *
     * @throws throw IllegalArgumentException if no enum instance of the generic type matches the given integer.
     */
     ...
     * but the conversion is done w.r.t. all enums of the generic type.
     *
     * @throws throw IllegalArgumentException if no enum instance of the generic type matches the given String.
     */
